...
while True:
    ...
    if a == 1:
        ...
        ID = Log_In(c)
        if c == 1:
            e = int(input('Enter 1 for adding workshop for student; Enter 2 for cancel workshop for student; Enter 3 for reading workshop for student; Enter 4 for reset the student Log_In password:\n'))
            Authority(e)
        if c == 2:
