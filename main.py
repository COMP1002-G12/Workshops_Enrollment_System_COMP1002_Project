...
while True:
    ...
    if num_a == 1:
        ...
        if num_c == 1:
            a = True
            while a:
                D = {1:"Input & Storage Workshops",2:"Delete Workshops",3:"Search Workshops",4:"Select Workshops for Students", 5:"Cancel the Workshops select by Students", 6:"Search & Read Log", 7:"Reset Students' Password", 8:"Log out"}
                print()
                print()
                print("-"*60)
